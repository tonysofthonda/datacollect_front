...
const IncomeDeduction = (incomeDeductionChildren: Account[], values: FinancialStateAccountValue[]): RowInput[] => {
  ...
  return [
    [
      {content: 'DEDUCCIONES A LOS INGRESOS', colSpan: 4, styles: headerStyle},
    ],
    [
    ...
    ...incomeDeductionChildren.map((account): CellDef[] =>
      [
